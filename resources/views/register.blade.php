...
@section('content')
    <div class="flex h-full flex-col md:flex-row">
        <div class="flex h-full w-full flex-col items-center"> {{-- Left Side --}}
            <img src={{ asset('assets/images/login/left-side-image.png') }} class="h-full w-full" alt="Left Side Image">
        </div>
        <div class="flex w-full flex-col justify-center rounded-br-xl rounded-tr-xl bg-slate-200 md:w-1/2">
            ...
            <form method="POST" action="{{ route('register') }}" class="mx-auto w-full max-w-sm">
                @csrf
                <label for="name-icon" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Nama
                    Lengkap</label>
                <div class="flex">
                    <span
                    ...
                    <input type="text" id="name-icon"
                        ...
                        placeholder="Ketik nama kamu disini..." name="name">
                </div>
                @error('name')
                ...
                <label for="email-address-icon"
                    class="mb-2 mt-4 block text-sm font-medium text-gray-900 dark:text-white">Email</label>
                <div class="flex">
                    <span
                        class="rounded-e-0 inline-flex items-center rounded-s-md border border-e-0 border-gray-300 bg-gray-200 px-3 text-sm text-gray-900 dark:border-gray-600 dark:bg-gray-600 dark:text-gray-400">
                        <svg class="h-4 w-4 text-gray-500 dark:text-gray-400" aria-hidden="true"
                ...
                <label for="password-confirmation-icon"
                    class="mb-2 mt-4 block text-sm font-medium text-gray-900 dark:text-white">Konfirmasi Kata Sandi</label>
                <div class="relative flex">
                    <span
                        class="rounded-e-0 inline-flex items-center rounded-s-md border border-e-0 border-gray-300 bg-gray-200 px-3 text-sm text-gray-900 dark:border-gray-600 dark:bg-gray-600 dark:text-gray-400">
                        <svg class="h-4 w-4 text-gray-500 dark:text-gray-400" viewBox="0 0 12 15" fill="currentColor"
                    ...
                    <input type="password" id="password-confirmation-icon"
                        class="block w-full min-w-0 flex-1 rounded-r-md border border-gray-300 bg-gray-50 p-2.5 !pr-8 text-sm text-gray-900 focus:border-solid focus:border-gray-900 focus:outline-none focus:ring-0 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400"
                        placeholder="Ketik konfirmasi kata sandi kamu disini..." name="password_confirmation">
                    <span class="absolute inset-y-0 right-0 flex cursor-pointer items-center p-2"
                        onclick="toggleConfirmPassword()">
                        <svg id="open-eye-confirm" width="24" height="24" class="hidden h-5 w-5" viewBox="0 0 24 24"
                            fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M12 9C11.2044 9 10.4413 9.31607 9.87868 9.87868C9.31607 10.4413 9 11.2044 9 12C9 12.7956 9.31607 13.5587 9.87868 14.1213C10.4413 14.6839 11.2044 15 12 15C12.7956 15 13.5587 14.6839 14.1213 14.1213C14.6839 13.5587 15 12.7956 15 12C15 11.2044 14.6839 10.4413 14.1213 9.87868C13.5587 9.31607 12.7956 9 12 9ZM12 17C10.6739 17 9.40215 16.4732 8.46447 15.5355C7.52678 14.5979 7 13.3261 7 12C7 10.6739 7.52678 9.40215 8.46447 8.46447C9.40215 7.52678 10.6739 7 12 7C13.3261 7 14.5979 7.52678 15.5355 8.46447C16.4732 9.40215 17 10.6739 17 12C17 13.3261 16.4732 14.5979 15.5355 15.5355C14.5979 16.4732 13.3261 17 12 17ZM12 4.5C7 4.5 2.73 7.61 1 12C2.73 16.39 7 19.5 12 19.5C17 19.5 21.27 16.39 23 12C21.27 7.61 17 4.5 12 4.5Z"
                                fill="black" />
                        </svg>
                        <svg id="close-eye-confirm" width="16" height="16" class="h-5 w-5" viewBox="0 0 16 16"
                            fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M10.79 12.912L9.176 11.297C8.55184 11.5202 7.87715 11.5615 7.23042 11.4162C6.58369 11.2709 5.99153 10.9449 5.52282 10.4762C5.05411 10.0075 4.72814 9.41531 4.58283 8.76858C4.43752 8.12185 4.47885 7.44716 4.702 6.823L2.642 4.763C0.938 6.278 0 8 0 8C0 8 3 13.5 8 13.5C8.96049 13.4975 9.91019 13.2973 10.79 12.912ZM5.21 3.088C6.08981 2.70266 7.03951 2.50251 8 2.5C13 2.5 16 8 16 8C16 8 15.061 9.721 13.359 11.238L11.297 9.176C11.5202 8.55184 11.5615 7.87715 11.4162 7.23042C11.2709 6.58369 10.9449 5.99153 10.4762 5.52282C10.0075 5.05411 9.41531 4.72814 8.76858 4.58283C8.12185 4.43752 7.44716 4.47885 6.823 4.702L5.21 3.088Z"
                                fill="black" />
                ...
                <button type="submit"
                    class="mt-4 w-full rounded-lg bg-blue-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Daftar</button>
            </form>
            <p class="mt-6 text-center">Sudah punya akun? <a href="{{ route('loginPage') }}"
                    class="font-medium text-blue-500">Login disini</a></p>
        </div>
    </div>
    <script>
