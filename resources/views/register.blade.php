        ...
        <div class="w-full md:w-1/2 bg-slate-200 flex flex-col justify-center rounded-tr-xl rounded-br-xl"> {{-- Right Side --}}
            ...
            <form method="POST" action="{{ route('register') }}" class="max-w-sm mx-auto w-full">
                ...
                <div class="flex">
                    ...
                    <input type="text" id="name-icon" class="rounded-r-md bg-gray-50 border text-gray-900 focus:border-gray-900 focus:border-solid focus:ring-0 focus:outline-none block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="Ketik nama kamu disini..." name="name">
                </div>
                @error('name')
                ...
                <div class="flex">
                    ...
                    <input type="text" id="email-address-icon" class="rounded-r-md bg-gray-50 border text-gray-900 focus:border-gray-900 focus:border-solid focus:ring-0 focus:outline-none block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="Ketik email kamu disini..." name="email">
                </div>
                @error('email')
                    <p class="text-red-500">{{ $message }}</p>
                @enderror
                ...
                <div class="flex">
                    ...
                    <input type="password" id="password-icon" class="rounded-r-md bg-gray-50 border text-gray-900 focus:border-gray-900 focus:border-solid focus:ring-0 focus:outline-none block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="Ketik kata sandi kamu disini..." name="password">
                </div>
                @error('password')
                    <p class="text-red-500">{{ $message }}</p>
                @enderror
                ...
                <div class="flex">
                    ...
                    <input type="password" id="password-confirmation-icon" class="rounded-r-md bg-gray-50 border text-gray-900 focus:border-gray-900 focus:border-solid focus:ring-0 focus:outline-none block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="Ketik konfirmasi kata sandi kamu disini..." name="password_confirmation">
                </div>
