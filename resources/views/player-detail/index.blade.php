        ...
        <div class="flex w-full gap-4">
            <div
                ...
                <div class="p-5">
                    ...
                    <p class="mb-3">{{ $user->biography ?? 'Pemain ini belum memiliki biografi.' }}</p>
                    @if ($user->gender === null)
                        <p>Gender pemain ini masih belum diketahui.</p>
                    @else
                        @if ($user->gender === 'Laki-laki')
                            <p>Pemain ini merupakan laki-laki.</p>
                        @else
                            <p>Pemain ini merupakan perempuan.</p>
                        @endif
                    @endif
                </div>
            </div>
            ...
            <div class="flex w-full flex-wrap gap-2">
                @if ($user->userPriceDetails->isEmpty())
                    <div class="flex w-full items-center justify-center text-lg font-bold">Pemain ini belum memiliki
                        permainan yang dimainkan.</div>
                @else
                    @foreach ($user->userPriceDetails as $userPriceDetail)
                        <div
                            ...
                            <a href="#">
                                <img class="h-48 rounded-t-lg object-cover"
                                    src="{{ $userPriceDetail->game->game_picture_url }}" alt="" />
                            </a>
                            <div class="p-5">
                                <a href="#">
