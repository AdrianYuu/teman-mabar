<nav class="border-gray-200 bg-white dark:bg-gray-900">
    <div class="mx-auto flex max-w-screen-xl flex-wrap items-center justify-between p-4">
        ...
        <a href="{{ route('indexPage') }}" class="flex items-center space-x-3 rtl:space-x-reverse">
            ...
            <span class="self-center whitespace-nowrap text-2xl font-semibold dark:text-white">TemanMabar</span>
        </a>
        {{-- Profile Dropdown --}}
        <div class="flex items-center space-x-3 rtl:space-x-reverse md:order-2 md:space-x-0">
            @auth
                ...
                <button type="button"
                    ...
                    <img class="h-8 w-8 rounded-full border-2 border-gray-600 object-fill"
                        src="{{ Auth::user()->profile_picture_url ? Auth::user()->profile_picture_url : asset('assets/images/Profile-icon.jpg') }}"
                        alt="user photo">
                </button>
                    ...
                    <ul class="py-2" aria-labelledby="user-menu-button">
                        <li>
                            <a href="{{ route('profilePage') }}"
                                class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-600 dark:hover:text-white">Profile
                                Saya</a>
                        </li>
                        <li>
                            <a href="{{ route('manageCoinPage') }}"
                                class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-600 dark:hover:text-white">Atur
                                Koin</a>
                        </li>
                        <li>
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button
                                class="block w-full px-4 py-2 text-left text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-600 dark:hover:text-white">Keluar</button>
                        </form>
                    </ul>
                </div>
            ...
            @guest
                <a href="{{ route('loginPage') }}"
                    class="mr-1 rounded-lg bg-blue-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login</a>
                <a href="{{ route('registerPage') }}"
                    class="rounded-lg bg-gray-500 px-5 py-2.5 text-sm font-medium text-white hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-300 dark:bg-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-800">Register</a>
            @endguest
        </div>
        <!-- Main Navbar -->
