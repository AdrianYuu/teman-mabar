                ...
                <ul class="space-y-2 font-medium">
                    ...
                    <li>
                        <button type="button"
                            ...
                            <span class="ms-3 flex-1 whitespace-nowrap text-left rtl:text-right">Items</span>
                        ...
                        <ul id="dropdown-example" class="hidden space-y-2 py-2">
                            <li>
                                <a href=""
                                    class="group flex w-full items-center rounded-lg p-2 pl-11 text-gray-900 transition duration-75 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Game</a>
                            </li>
                            <li>
                                <a href="{{ route('gameGenrePage') }}"
                                    class="group flex w-full items-center rounded-lg p-2 pl-11 text-gray-900 transition duration-75 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Game
                                    Genre</a>
                            </li>
                            <li>
                                <a href=""
                                    class="group flex w-full items-center rounded-lg p-2 pl-11 text-gray-900 transition duration-75 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Payment</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="#"
                            ...
                            <span
                                class="ms-3 inline-flex h-3 w-3 items-center justify-center rounded-full bg-blue-100 p-3 text-sm font-medium text-blue-800 dark:bg-blue-900 dark:text-blue-300">10</span>
                        </a>
                    </li>
                    <li>
                        <a href="#"
                    ...
                    <li>
                        <a href="#"
                            ...
                            <span class="ms-3 flex-1 whitespace-nowrap">Back</span>
                        </a>
                    </li>
                </ul>
            </div>
        </aside>
        <div class="ml-64 min-h-screen bg-slate-200 p-5">
            @yield('content')
        </div>
    </div>
</body>
