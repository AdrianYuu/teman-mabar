...
@section('content')
    <div class="flex flex-col w-1/2 items-center">
        ...
        <div class="w-full mt-8">
            <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
                <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-tab" data-tabs-toggle="#default-tab-content" role="tablist">
                    ...
                    @endforeach
                    <li>
                        <a href="" class="inline-block p-4 rounded-t-lg text-blue-500 hover:border-b-2">More...</a>
                    </li>
                </ul>
            </div>
        ...
        <div id="default-carousel" class="relative w-full" data-carousel="static">
            ...
            <!-- Previous button -->
            <button type="button" class="absolute bottom-[29%] -start-8 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none bg-black" data-carousel-prev>
            ...
            <!-- Next button -->
            <button type="button" class="absolute bottom-[29%] -end-10 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-next>
                <span class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-gray-400 dark:bg-gray-800/30 group-hover:bg-gray-500 dark:group-hover:bg-gray-800/60 dark:group-focus:ring-gray-800/70">
                    <svg class="w-4 h-4 text-gray-100 dark:text-gray-800 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 9 4-4-4-4"/>
                    </svg>
