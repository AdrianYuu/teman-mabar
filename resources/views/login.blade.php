    ...
    <div class="w-4/5 h-full flex p-12 flex-col md:flex-row">
        ...
        <div class="w-full md:w-1/2 bg-slate-200 flex flex-col justify-center rounded-tr-xl rounded-br-xl"> {{-- Right Side --}}
            ...
            <form method="POST" action="{{ route('login') }}" class="max-w-sm mx-auto w-full">
                ...
                @enderror
                <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mt-4">Masuk</button>
            </form>
