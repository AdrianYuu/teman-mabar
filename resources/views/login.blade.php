...
@section('content')
    <div class="w-4/5 h-full flex p-12 flex-col md:flex-row">
        ...
        <div class="w-full md:w-1/2 bg-slate-200 flex flex-col justify-center rounded-tr-xl rounded-br-xl"> {{-- Right Side --}}
            ...
            <form action="" class="max-w-sm mx-auto w-full">
                @csrf
                ...
                <div class="relative">
                    ...
                    <input type="text" id="password-icon" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Ketik kata sandi kamu disini...">
                </div>
