...
@section('content')
    <div class="flex flex-col items-center gap-12">
        ...
        @else
            <table class="text-left text-sm text-gray-500 rtl:text-right dark:text-gray-400">
                <thead class="bg-blue-100 text-xs uppercase text-gray-700 dark:bg-blue-800 dark:text-gray-400">
                    <tr>
                        <th scope="col" class="px-6 py-3 text-left">Nama game</th>
                        <th scope="col" class="px-6 py-3 text-left">Pemain</th>
                        <th scope="col" class="px-6 py-3 text-left">Pelanggan</th>
                        <th scope="col" class="px-6 py-3 text-left">Mulai</th>
                        <th scope="col" class="px-6 py-3 text-left">Selesai</th>
                        <th scope="col" class="px-6 py-3 text-left">Jumlah Pertandingan</th>
                ...
                <tbody>
                    @foreach ($ordersAsCustomer as $order)
                        <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                            ...
                            <td class="px-6 py-4">{{ $order->status === 'Finished' ? 'Selesai' : 'Belum Selesai' }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
