...
@section('title', 'Admin Dashboard | Game Genre')
...
@section('content')
    ...
    <div class="relative overflow-x-auto">
        <div class="mb-2 flex justify-end">
            <button type="button" onclick="window.location.href='{{ route('createGameGenrePage') }}'""
                    ...
                    @foreach ($gameGenres as $gameGenre)
                        <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <button type="button"
                                    onclick="window.location.href='{{ route('deleteGameGenrePage', ['id' => $gameGenre->id]) }}'""
