...
@section('title', 'Admin Dashboard | Create Game Genre')

@section('content')

    <form action={{ route('storeGameGenre') }} method="POST" class="max-w-8xl mx-auto">
        @csrf
        <div class="mb-3">
            ...
            <input type="text" id="name" name="name"
                ...
                placeholder="Input new genre name..." value="{{ old('name') }}" />
        </div>
        <button type="submit"
