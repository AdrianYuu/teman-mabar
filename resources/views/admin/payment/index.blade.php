...
@section('title', 'Admin Dashboard | Payment')
...
@section('content')
    ...
    <div class="relative overflow-x-auto">
        <div class="mb-2 flex justify-end">
            <button type="button" onclick="window.location.href='{{ route('createPaymentPage') }}'""
        ...
        @if ($payments->isEmpty())
            <p class="mt-2 text-center">There is no payment yet!</p>
        @else
            <table class="w-full text-left text-sm text-gray-500 rtl:text-right dark:text-gray-400">
                <thead class="bg-gray-50 text-xs uppercase text-gray-700 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        <th scope="col" class="w-10/12 px-6 py-3 text-left">
                            Payment Name
                        </th>
                        <th scope="col" class="w-2/12 px-6 py-3 text-left">
                            Actions
                        </th>
                    </tr>
                </thead>
                    ...
                    @foreach ($payments as $payment)
                        <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                            ...
                            <td class="flex px-6 py-4">
                                <button type="button"
                                    onclick="window.location.href='{{ route('editPaymentPage', ['id' => $payment->id]) }}'"
                                ...
                                <button type="button"
                                    onclick="window.location.href='{{ route('deletePaymentPage', ['id' => $payment->id]) }}'""
        ...
        {{ $payments->links('vendor.pagination.tailwind-custom') }}
