...
@section('title', 'Admin Dashboard | Delete Payment')

@section('content')

    <form action={{ route('destroyPayment', ['id' => $payment->id]) }} method="POST" class="max-w-8xl mx-auto mb-4">
        @method('DELETE')
        @csrf
        <div class="mb-3">
            ...
            <input type="text" id="name" name="name"
                ...
                disabled readonly value="{{ $payment->name }}" />
        </div>
