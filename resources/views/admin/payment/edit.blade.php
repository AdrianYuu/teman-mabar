...
@section('title', 'Admin Dashboard | Edit Payment')

@section('content')

    <form action={{ route('updatePayment', ['id' => $payment->id]) }} method="POST" class="max-w-8xl mx-auto mb-4">
        @method('PUT')
        @csrf
        <div class="mb-3">
            ...
            <input type="text" id="name" name="name"
                ...
                placeholder="Input new genre name..." value="{{ $payment->name }}" />
        </div>
        <button type="submit"
